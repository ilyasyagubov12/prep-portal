...
urlpatterns = [
    ...
    path("course-nodes/file-link/", CourseNodeFileLinkView.as_view(), name="course_nodes_file_link"),
    path("course-nodes/file/", CourseNodeFileView.as_view(), name="course_nodes_file"),
