...
from .views import (
    ...
    AssignmentFileLinkView,
    AssignmentFileAccessView,
...
urlpatterns = [
    ...
    path("assignments/file-link/", AssignmentFileLinkView.as_view(), name="assignments_file_link"),
    path("assignments/file/", AssignmentFileAccessView.as_view(), name="assignments_file"),
