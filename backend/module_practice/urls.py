...
from .views import (
    ...
    ModulePracticeResultVisibilitySetView,
...
urlpatterns = [
    ...
    path("module-practice/reorder/", ModulePracticeReorderView.as_view(), name="module_practice_reorder"),
    ...
    path("module-practice/export/", ModulePracticeExportView.as_view(), name="module_practice_export"),
    ...
    path("module-practice/results/set/", ModulePracticeResultVisibilitySetView.as_view(), name="module_practice_results_set"),
