"""
Django settings for prep_portal_api project.
...
# Override any existing environment values so local dev works reliably.
...
ROOT_URLCONF = 'prep_portal_api.urls'
...
WSGI_APPLICATION = 'prep_portal_api.wsgi.application'
